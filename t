...
local FluentTabs = {
    Combat = FluentWindow:AddTab({ Title = "Combat", Icon = "swords" }),
    Utility = FluentWindow:AddTab({ Title = "Utility", Icon = "settings" }),
    Fun = FluentWindow:AddTab({ Title = "Fun", Icon = "smile" })
}

-- Combat tab: Fast attack control
FluentTabs.Combat:AddToggle("FluentFastAttack", {
    Title = "Fast Attack",
    Default = true,
    Callback = function(Value)
...
-- Utility tab: performance and server controls
FluentTabs.Utility:AddButton({
    Title = "FPS Booster (strong)",
    Callback = function()
        pcall(FPSBooster)
    end
})
...
FluentTabs.Utility:AddButton({
    Title = "Hop Server (public)",
    Callback = function()
        pcall(HopServer)
    end
})

-- Fun tab: dance + bullet spam
FluentTabs.Fun:AddToggle("FluentDance", {
    Title = "Dance Loop",
    Default = false,
    Callback = function(Value)
        isDancing = Value
...
FluentTabs.Fun:AddToggle("FluentShoot", {
    Title = "Shoot Bullets",
    Default = false,
    Callback = function(Value)
        isShooting = Value
...
Fluent:Notify({
    Title = "Fluent UI",
    Content = "Painel extra carregado.",
    Duration = 5
})
